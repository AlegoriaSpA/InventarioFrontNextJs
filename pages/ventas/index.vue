                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12 my-auto ms-auto">
                                                <div class="input-group input-group-lg">
                                                    ...
                                                    <select name="" id=""
                                                        ...
                                                        <option class="text-dark" v-for="m in marcas" :value="m.id" :key="m">
                                                            {{m.nombre}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!-- <div class="d-flex mb-3">
                                                <div class="form-check form-switch ms-auto">
                                                    <input v-model="image" class="form-check-input" checked=""
                                                        type="checkbox">
                                                </div>
                                            </div> -->
                                        </div>
                            ...
                            <div class="col-12 py-2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3" v-for="m in articulosCategoria" :key="m">
                                        <PosArticulo-venta v-if="image == true" :articulo="m"
                                            @AddCarrito="AddCarrito"></PosArticulo-venta>
                                        <PosArticulo-venta-image v-else :articulo="m"
                                            @AddCarrito="AddCarrito"></PosArticulo-venta-image>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-xl-12">
                                ...
                                <div class="w-100">
                                    <div class="row">
                                        ...
                                        <div v-if="impresion==2" class="col-6 text-start ">
                                            ...
                                            <select name="" v-model="impreso_tipo" id="" class="form-control">
